...
void print(char* message){
    char *p_video_buffer = (char*) 0xb8280;
...
// or 
// nasm test.asm -f bin -o test.bin; gcc -m32 -ffreestanding -c kernel.c -o kernel.o -fno-pie && ld -o kernel.bin -Ttext 0x7e00 kernel.o -m elf_i386 --oformat binary && cat test.bin kernel.bin > all.bin && sudo dd if=all.bin of=/dev/sdc bs=512 count=20 conv=notrunc ; echo "d\nn\np\n\n\n\na\nw\n" | sudo fdisk /dev/sdc
